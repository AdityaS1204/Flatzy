        ...
        <section className="px-4 py-16 w-full">
            <div className="max-w-6xl mx-auto h-full flex justify-center flex-col">
                <motion.h2
                    ...
                    className="text-3xl md:text-4xl font-bold mb-8 text-gray-800 text-center flex flex-col items-center justify-center"
                >
                    What we do
                ...
                <div className="overflow-hidden w-full flex gap-6 h-full">
                    <motion.div
                        className="flex gap-20 h-full px-2 w-full"
                        initial={{ opacity: 0, x: -100 }}
                        whileInView={{ opacity: 1, x: 0 }}
                        transition={{ duration: 0.7 }}
                        viewport={{ once: true, amount: 0.2 }}
                    >
                        <div className='flex flex-col justify-center items-start gap-5 h-96 w-1/2'>
                        <p className='text-2xl font-semibold'>Our Mission</p>
                        <p>To build a rental ecosystem that is trustworthy, tech-driven, and designed to help students, professionals, and property owners save time, effort, and money.</p>
                            <p> At Flatzzy, we simplify the way people find and list rental spaces — whether it’s a student searching for a budget-friendly PG or an owner looking to rent out a property.
                                <br />
                        ...
                        <div className='right w-[500px] h-[450px] flex flex-col gap-5'>
                            <div>
                                <MarqueeComponent direction="right" speed={25} imgSrc={imgSrc} />
                            </div>
                            <div>
                                <MarqueeComponent direction="left" speed={25} cardSize={'h-28 w-44'} imgSrc={imgSrc} />
                            </div>
                            <div>
                                <MarqueeComponent direction="right" speed={25} imgSrc={imgSrc} />
                            </div>
